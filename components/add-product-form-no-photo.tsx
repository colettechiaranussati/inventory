...
export default function AddProductFormNoPhoto() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const productData = {
        ...
        photo_url: null, // No photo upload in this version
    ...
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader>
        ...
        <p className="text-sm text-muted-foreground">
          Note: Photo uploads require storage bucket setup. You can add photos later.
        </p>
      </CardHeader>
      <CardContent>
